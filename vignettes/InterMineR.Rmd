...
DataSet has a child called name. Add Gene.pathways.dataSets.name to the view. We'll add it as the last column, we can see from above there are 5 other columns already so we'll put it as #6:
